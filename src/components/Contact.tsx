...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const recipient = "antonyxavierjm@gmail.com";
        ...
        <div className="grid lg:grid-cols-5 gap-10 max-w-5xl mx-auto">
          ...
          >
            ...
            {contactInfo.map((item) => (
              <div
                key={item.title}
                className="group p-4 bg-card rounded-2xl border border-border card-hover"
              >
                {item.href ? (
                  <a href={item.href} className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="font-medium text-sm text-muted-foreground mb-0.5">
                        {item.title}
                      </h4>
